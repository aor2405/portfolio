        ...
        <div className="grid grid-cols-2 my-12">
          ...
          <div className="ml-4">
            ...
            <p className="pt-6 text-xl font-light font-paragraph col-span-8 mx-2 sm:mt-0 sm:text-2xl">
              I graduated college in 2014 with a degree in electronic
              engineering. Altough I started my career in engineering, I also
            ...
            <p className="pt-6 text-xl font-light font-paragraph col-span-8 mx-2 sm:mt-0 sm:text-2xl">
              ...
              past 5 years and been awarded the roll of team captain for 3 of
