  ...
  return (
    <>
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div className="sm:grid grid-cols-2 sm:my-12">
          <img
          ...
          />
          <div className="ml-4">
            <h3 className="text-3xl font-header col-span-4 mt-6 text-center sm:mt-0 sm:text-4xl sm:text-left">
              About me
            </h3>
            <p className="pt-3 text-xl font-light font-paragraph col-span-8 mx-2 sm:mt-0 sm:pt-6 sm:text-2xl">
